...
// --- COMMENT MODAL ---
const [commentDialog, setCommentDialog] = useState({ open: false, index: null, comment: "" });

const openCommentModal = (index) => {
  setCommentDialog({ open: true, index, comment: rows[index].comment || "" });
};

const saveCommentModal = () => {
  const updated = [...rows];
  if (commentDialog.index != null) {
    updated[commentDialog.index].comment = commentDialog.comment;
    setRows(updated);
  }
  setCommentDialog({ open: false, index: null, comment: "" });
};
